...
public class DacapoTransformPreprocess {
	...
	public static void main(String[] args) {
		...
		String argsOfAvrora = 
				"-f J -p cg reflection-log:"+cpath+"/refl.log "
			+"-pp -cp :" +jceJar + ":" + rtJar + ":"+ cpath //+":/home/lpxz/eclipse/workspace/avrora/bin"	// please reference the project	 
		+" -main-class "+ mainClass+" -d sootified/"+ featureStr+" "+mainClass;  
		//=====

		String argsOfmtrt = "-f c"	
			    +" -p cg reflection-log:"+cpath+"/refl.log" 
				+ " -pp -cp "
				+ jceJar + ":" + rtJar + ":" +cpath
				+ " -main-class "
				+ mainClass
